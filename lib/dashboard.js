...
<div class="sub">auto-refresh 5s · trace: ~/.dsh-webmcp/trace/ · <a href="/webmcp/status" style="color:#58a6ff">JSON status</a> · free &amp; subscription-free</div>
...
<h2>Config</h2>
<table>${cfgRows}</table>
<div class="empty" style="margin-top:16px">💜 support: <code>0xd8d99e14320003A6df684BE9255B4DD5e4AF474F</code> (USDC/USDT/ETH · Ethereum · USDC/USDT/BNB · BSC)</div>
<table>${cfgRows}</table>
</body></html>`
}
